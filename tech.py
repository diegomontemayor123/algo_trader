...
LOOKBACK = int(os.environ.get("LOOKBACK", 100))
...
class DifferentiableSharpeLoss(nn.Module):
    ...
    def forward(self, portfolio_weights, target_returns, model=None):
        ...
        loss = -sharpe_ratio #+ LOSS_RETURN_PENALTY * low_return_penalty  
