...
keys = ["SPLIT", "VAL_SPLIT", "PRED_DAYS", "LBACK", "SEED","MAX_HEADS", "BATCH", "FEAT","LAYERS", "YWIN", "Z_BETA", "Z_DECAY",
        ...
        "SD_PEN","SD_EXP", "TICK","START", "END", "TEST_CHUNK","MACRO", "PRUNEWIN","PRUNEDOWN","THRESH","NESTIM","SHORT_PER", "MED_PER", "LONG_PER","Z_ALPHA", "IMPDECAY", "TOPIMP"]

def load_config():
    float_keys = {"VAL_SPLIT", "DROPOUT", "DECAY", "RETURN_PEN","RETURN_EXP", "EXP_EXP",  "SD_PEN","SD_EXP","EXP_PEN","INIT_LR","THRESH","PRUNEDOWN", "Z_ALPHA","IMPDECAY","Z_DECAY","Z_BETA"}
