...
keys = ["SPLIT", "VAL_SPLIT", "PRED_DAYS", "LBACK", "SEED","MAX_HEADS", "BATCH", "FEAT","LAYERS", "YWIN",
        ...
        "SD_PEN","SD_EXP", "TICK","START", "END", "TEST_CHUNK", "RETRAIN","MACRO", "FEAT_PER","PRUNEWIN","THRESH","PRUNE","NESTIM"]

def load_config():
    float_keys = {"VAL_SPLIT", "DROPOUT", "DECAY", "RETURN_PEN","RETURN_EXP", "EXP_EXP", "WARMUP", "SD_PEN","SD_EXP","EXP_PEN","INIT_LR","THRESH",}
    int_keys = {"PRED_DAYS", "LBACK", "SEED", "MAX_HEADS", "BATCH","LAYERS", "EARLY_FAIL", "TEST_CHUNK", "RETRAIN","ATTENT","PRUNEWIN","NESTIM","YWIN"}
