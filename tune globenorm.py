...
def run_experiment(trial,study=None):
    config = {"START": trial.suggest_categorical("START", ["2011-10-01"]),#2019 Jan
        ...
        "YWIN": trial.suggest_int("YWIN",19,25),#29,28
        "PRUNEWIN": trial.suggest_int("PRUNEWIN",23,29),#31,28
        "PRUNEDOWN": trial.suggest_float("PRUNEDOWN",1,1.2),
        "THRESH": trial.suggest_int("THRESH",145,175),#170
        "NESTIM": trial.suggest_int("NESTIM",180,190),#200
        "BATCH": trial.suggest_int("BATCH",60,80),#53
        "LBACK": trial.suggest_int("LBACK",90,100),#84
        "PRED_DAYS": trial.suggest_int("PRED_DAYS",6,7,8),#6
        "DROPOUT": trial.suggest_float("DROPOUT",.032,.039),#.035
        "DECAY": trial.suggest_float("DECAY",.003,.0035,log=True),#.003
        "SHORT_PER": trial.suggest_int("SHORT_PER",13,17),#12
        "MED_PER": trial.suggest_int("MED_PER",20,24),#17
        "LONG_PER": trial.suggest_int("LONG_PER",64,81),#58
        "INIT_LR": trial.suggest_float("INIT_LR",.006,.008,log=True),#.001
        "EXP_PEN": trial.suggest_float("EXP_PEN",.23,.234),#.24
        "EXP_EXP": trial.suggest_float("EXP_EXP",1.8,1.8),#1.8
        "RETURN_PEN": trial.suggest_float("RETURN_PEN",.07,.074),#.073
        ...
        "LAYERS": trial.suggest_categorical("LAYERS",[2,3,4]),#2
        "EARLY_FAIL": trial.suggest_categorical("EARLY_FAIL",[6,7,8]),#2
