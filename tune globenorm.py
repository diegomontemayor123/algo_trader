...
def run_experiment(trial,study=None):
    config = {"START": trial.suggest_categorical("START", ["2012-01-01"]),#2019 Jan
        ...
        "YWIN": trial.suggest_int("YWIN",22,26),#29,28
        "PRUNEWIN": trial.suggest_int("PRUNEWIN",27,29),#31,28
        "PRUNEDOWN": trial.suggest_float("PRUNEDOWN",1.1,1.2),
        "THRESH": trial.suggest_int("THRESH",128,153),#170
        "NESTIM": trial.suggest_int("NESTIM",176,183),#200
        "BATCH": trial.suggest_int("BATCH",58,67),#53
        "LBACK": trial.suggest_int("LBACK",84,88),#84
        "PRED_DAYS": trial.suggest_int("PRED_DAYS",5,5),#6
        "DROPOUT": trial.suggest_float("DROPOUT",.035,.040),#.035
        ...
        "LONG_PER": trial.suggest_int("LONG_PER",50,57),#58
        "INIT_LR": trial.suggest_float("INIT_LR",.005,.01,log=True),#.001
        "EXP_PEN": trial.suggest_float("EXP_PEN",.23,.235),#.24
        "EXP_EXP": trial.suggest_float("EXP_EXP",1.8,1.8),#1.8
        "RETURN_PEN": trial.suggest_float("RETURN_PEN",.073,.076),#.073
        ...
        "MAX_HEADS": trial.suggest_categorical("MAX_HEADS",[2,3,4]),#1
        "LAYERS": trial.suggest_categorical("LAYERS",[3,4,5,6]),#2
        "EARLY_FAIL": trial.suggest_categorical("EARLY_FAIL",[1,2,3,4,5]),#2
