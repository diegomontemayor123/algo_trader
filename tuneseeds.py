...
def run_experiment(trial, study=None):
    config = {
        ...
        "YWIN": trial.suggest_int("YWIN", 15, 21),
        "PRUNEWIN": trial.suggest_int("PRUNEWIN", 15, 21),
        "PRUNEDOWN": trial.suggest_float("PRUNEDOWN", 1.3, 1.4),
        "THRESH": trial.suggest_int("THRESH", 50, 100),
        "NESTIM": trial.suggest_int("NESTIM", 200, 200),
        "TOPIMP": trial.suggest_int("TOPIMP", 100, 150),
        "IMPDECAY": trial.suggest_float("IMPDECAY", 0.85, 0.95),
        "RF_WEIGHT": trial.suggest_float("RF_WEIGHT", 0, 0.2),
        "TRANS_WEIGHT": trial.suggest_float("TRANS_WEIGHT", 0, 0.2),
        "BATCH": trial.suggest_int("BATCH", 32, 64),
        "LBACK": trial.suggest_int("LBACK", 50, 100),
        "PRED_DAYS": trial.suggest_int("PRED_DAYS", 6, 6),
        "DROPOUT": trial.suggest_float("DROPOUT", 0.03, 0.1, log=True),
        ...
        "INIT_LR": trial.suggest_float("INIT_LR", 0.002, 0.005, log=True),
        ...
        "Z_LOC": trial.suggest_float("Z_LOC", 0.8, 0.9),
        "Z_ANCH": trial.suggest_float("Z_ANCH", 0, 0.02),
        "ANCH_DECAY": trial.suggest_float("ANCH_DECAY", 0.99737139944604, 0.99737139944604),
        "MAX_HEADS": trial.suggest_int("MAX_HEADS", 1, 2),
        "LAYERS": trial.suggest_int("LAYERS", 1, 5),
        "EARLY_FAIL": trial.suggest_int("EARLY_FAIL", 3, 8),
        "VAL_SPLIT": trial.suggest_float("VAL_SPLIT", 0.15, 0.2),
