...
FEAT_OLD = ['adx','boll','cmo','crosscorr','crossrelstrength','crossretrank','crossvolz','ema','lags','logret','macd','meanabsreturn','price','pricevshigh','range','ret','rollret','rsi','sma','stoch','volchange','volptile','zscore','donchian']
