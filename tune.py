...
def run_experiment(trial,study=None):
    ...
    "YWIN": trial.suggest_int("YWIN", 19, 32),
    "PRUNEWIN": trial.suggest_int("PRUNEWIN", 23, 33),
    "PRUNEDOWN": trial.suggest_float("PRUNEDOWN", 1.0, 1.5531993941811406),
    "THRESH": trial.suggest_int("THRESH", 145, 199),
    "NESTIM": trial.suggest_int("NESTIM", 180, 200),
    ...
    "LONG_PER": trial.suggest_int("LONG_PER", 54, 81),
    "INIT_LR": trial.suggest_float("INIT_LR", 0.006019068920665291, 0.008, log=True),
    "EXP_PEN": trial.suggest_float("EXP_PEN", 0.23, 0.23781945911297195),
    "EXP_EXP": trial.suggest_float("EXP_EXP", 1.8, 1.8),
    "RETURN_PEN": trial.suggest_float("RETURN_PEN", 0.07073361803941373, 0.0755),
    "RETURN_EXP": trial.suggest_float("RETURN_EXP", 0.28, 0.28),
    "SD_PEN": trial.suggest_float("SD_PEN", 0.17, 0.175),
    "SD_EXP": trial.suggest_float("SD_EXP", 0.75, 0.76),
    "Z_ALPHA": trial.suggest_float("Z_ALPHA", 0, 1),
    "SEED": trial.suggest_categorical("SEED", [42]),
    "MAX_HEADS": trial.suggest_categorical("MAX_HEADS", [1, 2, 3]),
    "LAYERS": trial.suggest_categorical("LAYERS", [2, 3, 4, 5]),
    "EARLY_FAIL": trial.suggest_categorical("EARLY_FAIL", [6, 7, 8]),
