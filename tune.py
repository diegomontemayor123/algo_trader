...
def run_experiment(trial):
    config = {
        ...
        "INITIAL_CAPITAL": trial.suggest_float("INITIAL_CAPITAL", 100.0),
        ...
        "EPOCHS": trial.suggest_int("EPOCHS", 20),
        "MAX_HEADS": trial.suggest_int("MAX_HEADS", 20),
        "BATCH_SIZE": trial.suggest_int("BATCH_SIZE", 40),
        ...
        "LAYER_COUNT": trial.suggest_int("LAYER_COUNT", 6),
