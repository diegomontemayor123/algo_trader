...
def run_experiment(trial,study=None):
    config = {"START": trial.suggest_categorical("START", ["2012-01-01"]),#2019 Jan
        ...
        "YWIN": trial.suggest_int("YWIN",30,34),#29,28
        "PRUNEWIN": trial.suggest_int("PRUNEWIN",29,33),#31,28
        "PRUNEDOWN": trial.suggest_float("PRUNEDOWN",1.48,1.58),
        "THRESH": trial.suggest_int("THRESH",153,229),#170
        "NESTIM": trial.suggest_int("NESTIM",200,200),#200
        "BATCH": trial.suggest_int("BATCH",55,63),#53
        "LBACK": trial.suggest_int("LBACK",84,92),#84
        "PRED_DAYS": trial.suggest_int("PRED_DAYS",5,5),#6
        "DROPOUT": trial.suggest_float("DROPOUT",.038,.042),#.035
        "DECAY": trial.suggest_float("DECAY",.0033,.0033,log=True),#.003
        "SHORT_PER": trial.suggest_int("SHORT_PER",12,14),#12
        "MED_PER": trial.suggest_int("MED_PER",17,21),#17
        "LONG_PER": trial.suggest_int("LONG_PER",50,58),#58
        "INIT_LR": trial.suggest_float("INIT_LR",.006,.007,log=True),#.001
        "EXP_PEN": trial.suggest_float("EXP_PEN",.232,.238),#.24
        ...
        "EARLY_FAIL": trial.suggest_categorical("EARLY_FAIL",[5,6,7]),#2
