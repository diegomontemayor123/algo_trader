...
def run_experiment(trial,study=None):
    ...
    "YWIN": trial.suggest_int("YWIN", 20, 26),
    "PRUNEWIN": trial.suggest_int("PRUNEWIN", 20, 26),
    ...
    "LONG_PER": trial.suggest_int("LONG_PER", 60, 81),
    "INIT_LR": trial.suggest_float("INIT_LR", 0.005, 0.0064, log=True),
    ...
    "LAYERS": trial.suggest_categorical("LAYERS", [2,4,5]),
    "EARLY_FAIL": trial.suggest_categorical("EARLY_FAIL", [5,7,8]),
