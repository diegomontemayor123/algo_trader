...
def run_experiment(trial, study=None):
    ...
    "ANCHOR": trial.suggest_categorical("ANCHOR", ["2011-10-01"]),
    ...
    "DROPOUT": trial.suggest_float("DROPOUT", 0.03771491690014621, 0.03771491690014621),
    "DECAY": trial.suggest_float("DECAY", 0.003190861119627664, 0.003190861119627664),
    ...
    "INIT_LR": trial.suggest_float("INIT_LR", 0.005430727411696868, 0.005430727411696868),
