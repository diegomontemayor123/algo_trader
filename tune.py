...
def run_experiment(trial):
    config = {"START_DATE": trial.suggest_categorical("START_DATE", ["2017-01-01"]),
        ...
        "TICKERS": trial.suggest_categorical("TICKERS", ["AAPL,MSFT,GOOGL,AMZN,META,NVDA,TSLA","MSFT,GOOGL,AMZN,META,NVDA,TSLA","AAPL,GOOGL,AMZN,META,NVDA,TSLA","AAPL,MSFT,AMZN,META,NVDA,TSLA","AAPL,MSFT,GOOGL,META,NVDA,TSLA","AAPL,MSFT,GOOGL,AMZN,NVDA,TSLA","AAPL,MSFT,GOOGL,AMZN,META,TSLA","AAPL,MSFT,GOOGL,AMZN,META,NVDA","GOOGL,AMZN,META,NVDA,TSLA","META,NVDA,TSLA","NVDA,TSLA","AAPL,MSFT,GOOGL,AMZN,META"]),
        "MACRO":trial.suggest_categorical("MACRO", ["TNX,CPI,FEDFUNDS","CPI,FEDFUNDS","TNX,CPI","TNXFEDFUNDS","TNX","CPI","FEDFUNDS"]),
        ...
        "MAX_LEVERAGE": trial.suggest_float("MAX_LEVERAGE", 1.4,3),
