...
def run_experiment(trial,study=None):
    config = {"START": trial.suggest_categorical("START", ["2015-01-01"]),#2019 Jan
        ...
        "YWIN": trial.suggest_int("YWIN",29,29),#27/30
        "PRUNEWIN": trial.suggest_int("PRUNEWIN",31,31),#24/30
        ...
        "SHORT_PER": trial.suggest_int("SHORT_PER", 5, 10),
        "MED_PER": trial.suggest_int("MED_PER", 10, 50),
        "LONG_PER": trial.suggest_int("LONG_PER", 50, 120),
        ...
        "RETURN_PEN": trial.suggest_float("RETURN_PEN",.073,.073),#.07/.075
