...
def run_experiment(trial):
    config = {"START": trial.suggest_categorical("START", ["2019-01-01"]),
        ...
        "EXP_PEN": trial.suggest_float("EXP_PEN", 0.26, 0.26),#0.0038/0.0058/0.028/0.26 exp/sddenom/riskadjexp w sddenom/riskadj exp
        "EXP_EXP": trial.suggest_float("EXP_EXP", 1.8, 1.8),
        "RETURN_PEN": trial.suggest_float("RETURN_PEN", 0.118,0.118),#0.118/0.38 exp/sddenom
