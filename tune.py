...
def run_experiment(trial):
    config = {"START": trial.suggest_categorical("START", ["2019-01-01"]),#2019 Jan
        ...
        "RETURN_PEN": trial.suggest_float("RETURN_PEN",.062,.1),#.105 / .07
        "RETURN_EXP": trial.suggest_float("RETURN_EXP",.2,.28),#.28 / .344
        "SD_PEN": trial.suggest_float("SD_PEN",.12,.18),#.17 / .12 
        "SD_EXP": trial.suggest_float("SD_EXP",.7,.74),#.74 / .71 
