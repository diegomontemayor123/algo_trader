...
def run_experiment(trial):
    config = {
        ...
        "BATCH_SIZE": trial.suggest_int("BATCH_SIZE", 45, 60),
        "LOOKBACK": trial.suggest_int("LOOKBACK", 65, 75),
        "PREDICT_DAYS": trial.suggest_int("PREDICT_DAYS", 4, 9),
        ...
        "FEATURE_PERIODS": trial.suggest_categorical("FEATURE_PERIODS",["8,16","10,20","8,24","12,24"]),
        "L1_PENALTY": trial.suggest_float("L1_PENALTY", -0.001, 0.001), #-0.001, 0.001
