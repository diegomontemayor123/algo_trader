...
def run_experiment(trial, study=None):
    ...
    "TOPIMP": trial.suggest_int("TOPIMP", 30, 70),
    "IMPDECAY": trial.suggest_float("IMPDECAY", 0.92, 0.97),
    "RF_WEIGHT": trial.suggest_float("RF_WEIGHT", 0.3, 0.7),
    ...
    "Z_ALPHA": trial.suggest_float("Z_ALPHA", 0.75, 0.82),
    "Z_BETA": trial.suggest_float("Z_BETA", 0, 0.1),
    "Z_DECAY": trial.suggest_float("Z_DECAY", 0.98, 1),
    "SEED": trial.suggest_categorical("SEED", [42]),
    "MAX_HEADS": trial.suggest_categorical("MAX_HEADS", [1,2,3,4]),
    "LAYERS": trial.suggest_categorical("LAYERS", [2,3,4,5]),
    "EARLY_FAIL": trial.suggest_categorical("EARLY_FAIL", [3,4,5]),
