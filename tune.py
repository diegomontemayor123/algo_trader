...
def run_experiment(trial):
    config = {
        ...
        "TICKERS": trial.suggest_categorical("TICKERS", ['ORCL,GOOGL,JPM,PFE,MSFT,T,KO,UNH,GE,CAT,TSLA,AAPL',
                                                         'ORCL,GOOGL,JPM,PFE,MSFT',
                                                         'ORCL,GOOGL,JPM,PFE,MSFT,T',
                                                         'ORCL,GOOGL,JPM,PFE,MSFT,T,KO',
                                                         'ORCL,GOOGL,JPM,PFE,MSFT,T,KO,UNH',
                                                         'ORCL,GOOGL,JPM,PFE,MSFT,T,KO,UNH,GE',
                                                         'ORCL,GOOGL,JPM,PFE,MSFT,T,KO,UNH,GE,CAT',
                                                         'ORCL,GOOGL,JPM,PFE,MSFT,T,KO,UNH,GE,CAT,TSLA',
]),
        "MACRO": trial.suggest_categorical("MACRO",['FEDFUNDS,^IXIC,CL=F,GC=F,NG=F,ZW=F,USDJPY=X,^TNX,^FVX,IEF,UUP',
                                                    'FEDFUNDS,ZW=F,^FVX',
                                                    'FEDFUNDS,ZW=F,^FVX,^IXIC',
                                                    'FEDFUNDS,ZW=F,^FVX,^IXIC,^TNX',
                                                    'FEDFUNDS,^IXIC,^FVX,GC=F,^TNX,ZW=F',
                                                    'FEDFUNDS,^IXIC,^FVX,CL=F,^TNX,ZW=F,USDJPY=X',
                                                    'FEDFUNDS,^IXIC,^FVX,GC=F,CL=F,ZW=F,USDJPY=X,^TNX',
                                                    'FEDFUNDS,^IXIC,CL=F,GC=F,IEF,ZW=F,USDJPY=X,^TNX,^FVX',
                                                    'FEDFUNDS,^IXIC,CL=F,GC=F,UUP,ZW=F,USDJPY=X,^TNX,^FVX,IEF',]),
        "FEATURES": trial.suggest_categorical("FEATURES", ['ret,volume,momentum,cmo,rsi,ema,rolling_ret',
                                                           'ret,volume,momentum,cmo,log_ret',
                                                           'ret,volume,momentum,cmo,rsi,log_ret',
                                                           'ret,volume,momentum,cmo,rsi,ema,log_ret',
                                                           'ret,volume,momentum',
                                                           'ret,volume,momentum,cmo',
                                                           'ret,volume,momentum,cmo,rsi',
                                                           'ret,volume,momentum,cmo,rsi,ema',]),
        ...
        "LOOKBACK": trial.suggest_int("LOOKBACK", 60, 80),
        "PREDICT_DAYS": trial.suggest_int("PREDICT_DAYS", 1, 9),
        "WARMUP_FRAC": trial.suggest_float("WARMUP_FRAC", 0.1, 0.2),
        "DROPOUT": trial.suggest_float("DROPOUT", 0.001, 0.0791),
        "DECAY": trial.suggest_float("DECAY", 0.001, 0.04),
        "FEATURE_ATTENTION_ENABLED": trial.suggest_int("FEATURE_ATTENTION_ENABLED", 1, 1),
        "FEATURE_PERIODS": trial.suggest_categorical("FEATURE_PERIODS",["5,10,20,40","5,10,20","10,20,40","10,20","5,10"]),
        "L1_PENALTY": trial.suggest_float("L1_PENALTY", 0.000667, 0.000667), #-0.001, 0.001
        "INIT_LR": trial.suggest_float("INIT_LR",0.5,0.5),
        "LOSS_MIN_MEAN": trial.suggest_float("LOSS_MIN_MEAN", 0.016676, 0.016676),
        "LOSS_RETURN_PENALTY": trial.suggest_float("LOSS_RETURN_PENALTY", 0.024, 0.024),
