...
def main():
    ...
    feat_names = FEAT_LONG
    macro_keys = MACRO_LONG
    ...
    top_macros = [f for f in top_30_features if f in MACRO_LONG]
    top_feats = [f for f in top_30_features if f not in MACRO_LONG]
